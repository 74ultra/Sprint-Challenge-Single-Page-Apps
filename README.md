...
> Answer: Client side routing allows part of the work of the application to be done on the client side (in the browser). This reduces the amount of server requests. The application does not need to contact the server everytime something changes.
- [ ] What does AJAX stand for?
> Answer: Asynchronous Javascript and XML
- [ ] What are `controlled components` in React?
> Answer: Controled components can take its current value through 'props' and updates the parent component of changes using callback functions.
